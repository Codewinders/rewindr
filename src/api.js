...
export const api = {
  ...
  acceptOffer: (id) => request("POST", `/api/threads/${id}/offer`, { action: "accept" }),
  rejectOffer: (id) => request("POST", `/api/threads/${id}/offer`, { action: "reject" }),
  counterOffer: (id, amount) => request("POST", `/api/threads/${id}/offer`, { action: "counter", amount }),
  payOffer: (id, delivery) => request("POST", `/api/threads/${id}/pay`, { delivery }),
