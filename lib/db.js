...
export function publicUser(u) {
  if (!u) return null;
  return { username: u.username, verified: !!u.verified, isAdmin: !!u.is_admin, banned: !!u.banned, freeFeeCredits: u.free_fee_credits || 0 };
}
...
export function publicListing(l) {
  return {
    ...
    sold: !!l.sold, soldAt: l.sold_at, shelfOnly: !!l.shelf_only,
...
export async function fullThread(env, id) {
  ...
  return {
    ...
    status: t.status, ownerConfirmed: !!t.owner_confirmed, buyerConfirmed: !!t.buyer_confirmed,
    offerAmount: t.offer_amount, offerTurn: t.offer_turn, offerStatus: t.offer_status,
