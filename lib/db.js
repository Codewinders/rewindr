...
export const DEMO_VERIFY_CODE = "123456"; // TODO: byt mot riktig kod när e-post är kopplat
...
export function publicListing(l) {
  return {
    ...
    price: l.price, owner: l.owner, note: l.note, imageUrl: l.image_url, forSale: !!l.for_sale,
